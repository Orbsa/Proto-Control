/*
 * Roto-Control TeamSpeak 3 Plugin
 *
...
PLUGINS_EXPORTDLL const char *ts3plugin_author()      { return "rotocontrol"; }
...
PLUGINS_EXPORTDLL int ts3plugin_init() {
    ...
    snprintf(socket_path, sizeof(socket_path), "%s/.ts3client/rotocontrol-ts3.sock",
             home ? home : "/tmp");
